...
<?php wp_footer(); ?>
    ...
    <script src="/wp-content/themes/twentyfifteen/js/reduxlinechart.min.js" type="text/javascript">
      </script>
                <script src="/wp-content/themes/twentyfifteen/js/dial-chart.min.js" type="text/javascript">
     </script>
</body>
</html>
